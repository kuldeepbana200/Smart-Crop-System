...
const labelsByLanguage = {
  en: {
    ...
    subtitle:
      "Latest available market prices for your crops. All prices are sourced from our verified market dataset. Verify the latest price with your local mandi before selling.",
    myCrops: "My Crops",
    ...
    dataSource:
      "Market prices are sourced from the system's verified market dataset.",
    notAvailable: "Not available",
    loading_prices: "Loading prices...",
    loading_insight: "Loading insight...",
  },
  hi: {
    marketPrices: "बाजार कीमतें",
    marketDashboard: "बाजार डैशबोर्ड",
    subtitle:
      "आपकी फसलों के लिए नवीनतम उपलब्ध बाजार कीमतें। सभी कीमतें हमारे सत्यापित बाजार डेटासेट से ली गई हैं। बेचने से पहले अपने स्थानीय मंडी से नवीनतम कीमत सत्यापित करें।",
    myCrops: "मेरी फसलें",
    ...
    loading_insight: "अंतर्दृष्टि लोड हो रही है...",
  },
  or: {
    marketPrices: "ବଜାର ମୂଲ୍ୟ",
    marketDashboard: "ବଜାର ଡ୍ୟାଶବୋର୍ଡ",
    subtitle:
      "ଆପଣଙ୍କ ଫସଲ ପାଇଁ ନବୀନତମ ଉପଲବ୍ଧ ବଜାର ମୂଲ୍ୟ। ସମସ୍ତ ମୂଲ୍ୟ ଆମର ସତ୍ୟାପିତ ବଜାର ଡେଟାସେଟ ଠାରୁ ସୋର୍ସ। ବିକ୍ରୟ କରିବା ପୂର୍ବରୁ ଆପଣଙ୍କ ସ୍ଥାନୀୟ ମଣ୍ଡିରୁ ସର୍ବଶେଷ ମୂଲ୍ୟ ଯାଞ୍ଚ କରନ୍ତୁ।",
    myCrops: "ମୋର ଫସଲ",
    ...
    loading_prices: "ମୂଲ୍ୟ ଲୋଡ୍ ହେଉଛି...",
    loading_insight: "ବ୍ୟାଖ୍ୟା ଲୋଡ୍ ହେଉଛି...",
  },
  mr: {
    ...
    loading_prices: "भाव लोड होत आहेत...",
    loading_insight: "व्याख्या लोड होत आहे...",
  },
};
