...
class AdvisoryServiceTest {
    ...
    void setUp() {
        ...
        advisoryService = new AdvisoryService(
                userRepository, farmerRepository, cropRepository, weatherService, ruleEngine);
    ...
    void generatesAdvisoryOnlyForAuthenticatedFarmersCrop() {
        ...
        Crop crop = new Crop(30L, farmer, "Rice", "FLOWERING", null, null, null);
        ...
        when(ruleEngine.generate(crop, null)).thenReturn(List.of(mock(AdvisoryRecommendation.class)));

        advisoryService.generateAdvisory(new GenerateAdvisoryRequest(30L), authentication);
    ...
    void treatsNonOwnedCropAsNotFound() {
        ...
        AdvisoryService.CropNotFoundException exception = assertThrows(
                ...
                () -> advisoryService.generateAdvisory(new GenerateAdvisoryRequest(99L), authentication));

        assertEquals(AdvisoryService.CropNotFoundException.class, exception.getClass());
    }
}
