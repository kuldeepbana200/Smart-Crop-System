...
public class EducationResourceDataLoader implements ApplicationRunner {
    ...
    public EducationResourceDataLoader(EducationResourceRepository educationResourceRepository, Environment environment) {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        resources.add(createResource("hi", "crop_basics", "फसल उत्पादन के लिए मिट्टी के प्रकार को समझें",
                "सandy, दोमट, और बलुई मिट्टी की पहचान करना और प्रत्येक प्रकार के लिए उपयुक्त फसलों के बारे में जानें। क्षेत्र में मिट्टी परीक्षण के सरल तरीके शामिल हैं।",
                null));
        ...
        resources.add(createResource("hi", "weather", "अप्रत्याशित फ्रॉस्ट से फसलों की सुरक्षा",
                ...
                null));
        resources.add(createResource("hi", "market_storage", "अनाज भंडारण में नुकसान कम करने के सर्वोत्तम तरीके",
        ...
        resources.add(createResource("or", "crop_basics", "ଫସଳୁତ୍ପାଦନ ପାଇଁ ମାଟିର ପ୍ରକାରକୁ ବୁଝିବେ",
                "ରେଡ୍, ଲୋମ, ଏବଂ ବାଲୁଇ ମାଟିର ପ୍ରକାରଗୁଡ଼ିକରେ ପରିଚୟ ପାଇଁ ���ଣିକା ଏବଂ କେତେପାକି ମାଟିରେ ଟେସ୍ଟିଙ୍ଗ କରିବାର ସାଧାରଣ ପଦଧତି।",
                null));
        ...
        resources.add(createResource("mr", "irrigation", "लहान शेतकरींसाठी ड्रिप इर्रिगेशन मूलभूत",
                "कम खर्चाचा ड्रिप सिस्टम स्थापित करणे, पाणी वगळण्याचा रेट तयार करणे, वसतीचा determination, व देखभालच्या टिप्स.",
                null));
        resources.add(createResource("mr", "pests_diseases", "फॉल आर्मीवर्मची ओळख व व्यवस्थापन",
                "जeeवनचक्र, क्षतीचे लक्षण, स्कूटिंग paddhati, व एकीकृत कीट व्यवस्थापन उपाय.",
                null));
        ...
        resources.add(createResource("mr", "weather", "अप्रत्याशित फ्रॉस्ट पासून पिकांची सुरक्षा",
                "मुल्चिंग, विंडब्रेक, व पाणी देण्याचा timing जोडून फ्रॉस्ट neutralization करणे.",
                null));
        resources.add(createResource("mr", "market_storage", "धान्याखालील हानि टाळण्यासाठी सर्वोत्तम भंडारण पद्धती",
                "शुध carrier, सुखविणे, एअरटाइट कंटेनर, नियमित determination यांच्या द्वारा कवक व कीट टाळणे.",
                null));

        educationResourceRepository.saveAll(resources);
    }

    private EducationResource createResource(String language, String category, String title, String content, String externalUrl) {
